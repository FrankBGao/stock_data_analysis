...
def run_a_stock(code):
    ...
    return a_trading_record, a_result
...
def run_many_stock(codes):
    ...
    for i in codes:
        print("running" + i)
        try:
            a_trading_record, a_result = run_a_stock(i)
    ...
    return all_trading_record, all_result
...
if __name__ == '__main__':
    ...
    this_all_trading_record, this_all_result = run_many_stock(this_codes)

...
def regress_trading(function_dict, data, trader, stock_code):
    ...
    for i in range(max_one_slide, len(data)):
        ...
        trader = earn_percent_w_smart_start_w_small_steps_w_safety_double(ding_di, trader, stock_info, 0.05,
                                                                          safety_down=0.2,
                                                                          safety_up=0.1,
...
if __name__ == '__main__':
    ...
    this_code = "600805"  # 600036 # 600298 # 000858 # 000725 # 600999 # 600030
